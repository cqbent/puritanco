...
<?php
	...
	wp_enqueue_style("puritanco_css", get_stylesheet_directory_uri()."/css/puritanco.css", false, $pp_theme_version, "all");
	...
	wp_enqueue_style("fancybox_css", get_stylesheet_directory_uri()."/js/fancybox/jquery.fancybox-1.3.0.css", false, $pp_theme_version, "all"); 
        wp_enqueue_style("jquery_custom_scrollbar", get_stylesheet_directory_uri()."/css/jquery.custom-scrollbar.css", false, $pp_theme_version, "all"); 
...
<?php
	...
	wp_enqueue_script("jquery_custom_scrollbar_js", get_stylesheet_directory_uri()."/js/jquery.custom-scrollbar.js", false, $pp_theme_version);
	...
	<!-- Begin template wrapper -->
		...
		<div id="menu_wrapper">
		    ...
		    <div id="menu_footer">
				...
				?>
                <img src="<?php echo bloginfo( 'stylesheet_directory' ); ?>/images/social-media.png" alt="social media" usemap="#Map" border="0" />
                <map name="Map" id="Map">
                    <area shape="rect" coords="-5,1,23,21" href="http://www.facebook.com/PuritanCo" target="_blank" />
                    <area shape="rect" coords="49,0,74,21" href="http://twitter.com/PuritanCo" target="_blank" />
                    <area shape="rect" coords="24,-5,47,21" href="http://blog.puritancambridge.com/" target="_blank" />
                    <area shape="rect" coords="77,0,99,20" href="http://instagram.com/puritanco/" target="_blank" />
                 </map>
...
<script>
var menu_key = 1;
//$j('.nav li').not(".blog, .menu-item-type-custom, .menu-item-object-post, .menu-item-object-category, .menu-item-object-post_tag, .menu-item-object-page").each(function()
$j('.nav li.menu-item-object-gallery').each(function()
{
