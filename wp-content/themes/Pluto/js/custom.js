...
$j(document).ready(function(){ 
	...
	//$j('.nav li').not(".blog, .menu-item-type-custom, .menu-item-object-post, .menu-item-object-category, .menu-item-object-post_tag, .menu-item-object-page").unbind("click").click(function(){
	$j('.nav li.menu-item-object-gallery').unbind("click").click(function(){
